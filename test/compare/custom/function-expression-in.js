...
var baz = function(){something();};
var bazArg = function(a,b,c){something();};
...
// Named function expression with body
call(function test(){something();});
call(x,function test(){x();});
call(function test(){x();},x);

// Named function expression with body and arguments
call(function testArg(a,b,c){something();});
call(x,function testArg(a,b,c){x();});
call(function testArg(a,b,c){x();},x)
...
call(function(a,b,c){something();});
call(x,function(a,b,c){x();});
call(function(a,b,c){x();},x);
...
var object = {
	...
	// Anonymous function expression with body
	baz: function(){something();},
	bazArg: function(a,b,c){something();},
