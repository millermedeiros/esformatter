...
exports.VariableDeclaration = function(node){
    ...
    _tk.removeWsBrInBetween(node.startToken, node.declarations[0].startToken);
...
exports.TryStatement = function(node){
    ...
    node.handlers.forEach(function(handler){
        _brws.aroundIfNeeded(handler.body.startToken, 'CatchOpeningBrace');
        _brws.aroundIfNeeded(handler.body.endToken, 'CatchClosingBrace');
    });
