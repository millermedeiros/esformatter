...
module.exports = function ForStatement(node) {
  ...
  _br.limit(expressionStart, 'ForStatementExpressionOpening');
  _ws.limit(expressionStart, 'ForStatementExpressionOpening');

  _br.limit(expressionEnd, 'ForStatementExpressionClosing');
  _ws.limit(expressionEnd, 'ForStatementExpressionClosing');
